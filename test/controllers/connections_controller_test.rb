...
class ConnectionsControllerTest < ActionController::TestCase
  ...
  test "should create connection" do
    assert_difference('Connection.count') do
      post :create, connection: { comments: @connection.comments, date: @connection.date, location: @connection.location, rating: @connection.rating }
    end
  ...
  test "should update connection" do
    patch :update, id: @connection, connection: { comments: @connection.comments, date: @connection.date, location: @connection.location, rating: @connection.rating }
    assert_redirected_to connection_path(assigns(:connection))
  end
